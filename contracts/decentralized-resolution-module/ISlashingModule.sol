...
interface ISlashingModule {
     ...
     */
    function appealSlash(uint256 slashId, string calldata reason, bytes calldata evidence) external;
    ...
    function calculateDistribution(
        uint256 amount,
        SlashReason reason
    ) external view returns (SlashDistribution memory distribution);
     ...
     */
    function claimInsurancePayout(uint256 workflowId, address to, uint256 amount) external;
