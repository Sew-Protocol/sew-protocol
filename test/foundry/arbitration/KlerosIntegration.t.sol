...
contract KlerosIntegrationTest is Test {
    ...
    function setUp() public {
        ...
        vm.deal(escrowContract, 10 ether);
    ...
    function test_registerEscrowContract_success() public {
        klerosProxy.registerEscrowContract(escrowContract);
        bytes32 ROLE = klerosProxy.ROLE_ESCROW_CONTRACT();
        assertTrue(klerosProxy.hasRole(ROLE, escrowContract));
    }
    ...
    function test_createDispute_success() public {
        ...
        klerosProxy.createDispute{value: ARBITRATION_PRICE}(1, escrowContract, 2, '0x', escrowData);
    }
    ...
    function test_createDispute_insufficientFee() public {
        ...
        klerosProxy.createDispute{value: 0}(1, escrowContract, 2, '0x', escrowData);
    }
    ...
    function test_createDispute_refundsExcess() public {
        ...
        uint256 before = escrowContract.balance;
        vm.prank(escrowContract);
        klerosProxy.createDispute{value: ARBITRATION_PRICE * 2}(1, escrowContract, 2, '0x', escrowData);
        uint256 balanceAfter = escrowContract.balance;
    ...
    function test_createDispute_storesMetadata() public {
        ...
        (, , , , bool resolved, uint256 ruling, address from, address to, uint256 amount) = klerosProxy.disputes(escrowContract, 1);
    ...
    function test_createDispute_createsMappings() public {
        ...
        assertEq(klerosProxy.workflowToKlerosDispute(escrowContract, 1), 1);
    ...
    function test_submitEvidence_fromSender() public {
        ...
        klerosProxy.submitEvidence(1, escrowContract, 'ipfs://test');
    }
    ...
    function test_submitEvidence_fromRecipient() public {
        ...
        klerosProxy.submitEvidence(1, escrowContract, 'ipfs://test2');
    }
    ...
    function test_submitEvidence_fromAnyone() public {
        ...
        klerosProxy.submitEvidence(1, escrowContract, 'ipfs://test3');
    }
    ...
    function test_submitEvidence_multipleSubmissions() public {
        ...
        vm.prank(sender);
        klerosProxy.submitEvidence(1, escrowContract, '1');

        vm.prank(recipient);
        klerosProxy.submitEvidence(1, escrowContract, '2');

        vm.prank(other);
        klerosProxy.submitEvidence(1, escrowContract, '3');
    }

    function test_submitEvidence_rejectsNonExistent() public {
        vm.expectRevert('Dispute does not exist');
        klerosProxy.submitEvidence(999, escrowContract, 'test');
    }
    ...
    function test_submitEvidence_rejectsAfterResolution() public {
        ...
        klerosProxy.submitEvidence(1, escrowContract, 'late');
    }
    ...
    function test_rule_storesRuling() public {
        ...
        (bool resolved, uint256 ruling) = klerosProxy.getRuling(1, escrowContract);
        assertTrue(resolved);
        assertEq(ruling, 1);
    }
    ...
    function test_rule_updatesMetadata() public {
        ...
        (, , , , bool resolved, uint256 ruling, , , ) = klerosProxy.disputes(escrowContract, 1);
        assertTrue(resolved);
        assertEq(ruling, 2);
    }
    ...
    function test_getRuling_beforeResolution() public {
        ...
        (bool resolved, ) = klerosProxy.getRuling(1, escrowContract);
        assertFalse(resolved);
    }
    ...
    function test_getDisputeResolver() public {
        (address resolver, uint8 level) = klerosProxy.getDisputeResolver(1, escrowContract, '0x');
    ...
    function test_isAuthorizedDisputeResolver_others() public {
        (bool authorized, ) = klerosProxy.isAuthorizedDisputeResolver(1, escrowContract, sender, '0x');
        assertFalse(authorized);
    }

    function test_canEscalate_prevention() public {
        (bool canEscalate, , ) = klerosProxy.canEscalate(1, escrowContract, 2, '0x');
        assertFalse(canEscalate);
    }

    function test_executeEscalation_reverts() public {
        vm.expectRevert('No escalation from Kleros');
        klerosProxy.executeEscalation(1, escrowContract, '0x');
    }
    ...
    function test_multipleDisputes_handleIndependently() public {
        ...
        vm.prank(escrowContract);
        klerosProxy.createDispute{value: ARBITRATION_PRICE}(2, escrowContract, 2, '0x', escrowData);

        assertEq(klerosProxy.workflowToKlerosDispute(escrowContract, 1), 1);
        assertEq(klerosProxy.workflowToKlerosDispute(escrowContract, 2), 2);
    }
    ...
    function test_multipleDisputes_differentRulings() public {
        ...
        (, uint256 r1) = klerosProxy.getRuling(1, escrowContract);
        (, uint256 r2) = klerosProxy.getRuling(2, escrowContract);
    ...
    function test_edgeCase_zeroWorkflow() public {
        (bool resolved, ) = klerosProxy.getRuling(0, escrowContract);
        assertFalse(resolved);
    }

    function test_edgeCase_largeWorkflow() public {
        (bool resolved, ) = klerosProxy.getRuling(type(uint256).max, escrowContract);
        assertFalse(resolved);
    }
}
