...
contract DRv1WorkloadRoutingTest is Test {
    ...
    event ResolverAppointed(
        address indexed resolver,
        DecentralizedResolverStructs.ResolverRole role,
    ...
    function setUp() public {
        ...
        vm.startPrank(owner);
        module.grantRole(ROLE_TIMELOCK, owner);
    ...
    function test_SetResolverAssignmentWeight_Success() public {
        ...
        DecentralizedResolverStructs.ResolverStats memory stats = module.getDisputeResolverStats(
            resolver1
        );
    ...
    function test_GetV1PhaseGateMetrics_NoDisputes() public {
        (uint256 escalationRate, uint256 avgResponseTime, uint256 activeResolvers) = module
            .getV1PhaseGateMetrics();
