...
contract Test_05_ModuleSnapshotting_test is Test {
    ...
    function test_snapshot_emitted_on_createEscrow() public {
        ...
        // create escrow
        EscrowSettings memory settings = EscrowSettings({ customResolver: address(0), yieldEnabled: false, autoReleaseTime: 0, autoCancelTime: 0, escrowType: EscrowType.STANDARD });
        vm.prank(sender);
