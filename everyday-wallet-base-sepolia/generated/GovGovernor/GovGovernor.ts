...
export class AbsoluteQuorumUpdated extends ethereum.Event {
  get params(): AbsoluteQuorumUpdated__Params {
    return new AbsoluteQuorumUpdated__Params(this);
  }
}

export class AbsoluteQuorumUpdated__Params {
  _event: AbsoluteQuorumUpdated;

  constructor(event: AbsoluteQuorumUpdated) {
    this._event = event;
  }
...
export class NonCirculatingAddressAdded extends ethereum.Event {
  get params(): NonCirculatingAddressAdded__Params {
    return new NonCirculatingAddressAdded__Params(this);
  }
}

export class NonCirculatingAddressAdded__Params {
  _event: NonCirculatingAddressAdded;

  constructor(event: NonCirculatingAddressAdded) {
    this._event = event;
  }
...
export class NonCirculatingAddressRemoved extends ethereum.Event {
  get params(): NonCirculatingAddressRemoved__Params {
    return new NonCirculatingAddressRemoved__Params(this);
  }
}

export class NonCirculatingAddressRemoved__Params {
  _event: NonCirculatingAddressRemoved;

  constructor(event: NonCirculatingAddressRemoved) {
    this._event = event;
  }
...
export class GovGovernor__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class GovGovernor__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GovGovernor extends ethereum.SmartContract {
  static bind(address: Address): GovGovernor {
    return new GovGovernor("GovGovernor", address);
  }
  ...
  MAX_NON_CIRCULATING_ADDRESSES(): BigInt {
    let result = super.call(
      "MAX_NON_CIRCULATING_ADDRESSES",
      "MAX_NON_CIRCULATING_ADDRESSES():(uint256)",
      [],
    );
  ...
  try_MAX_NON_CIRCULATING_ADDRESSES(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAX_NON_CIRCULATING_ADDRESSES",
      "MAX_NON_CIRCULATING_ADDRESSES():(uint256)",
      [],
  ...
  absoluteQuorum(): BigInt {
    let result = super.call("absoluteQuorum", "absoluteQuorum():(uint256)", []);

    return result[0].toBigInt();
  }

  try_absoluteQuorum(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "absoluteQuorum",
      "absoluteQuorum():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  eip712Domain(): GovGovernor__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new GovGovernor__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<GovGovernor__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new GovGovernor__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  getCirculatingSupply(blockNumber: BigInt): BigInt {
    let result = super.call(
      "getCirculatingSupply",
      "getCirculatingSupply(uint256):(uint256)",
  ...
  try_getCirculatingSupply(blockNumber: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCirculatingSupply",
      "getCirculatingSupply(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(blockNumber)],
  ...
  getCurrentCirculatingSupply(): BigInt {
    let result = super.call(
      "getCurrentCirculatingSupply",
      "getCurrentCirculatingSupply():(uint256)",
      [],
    );
  ...
  try_getCurrentCirculatingSupply(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCurrentCirculatingSupply",
      "getCurrentCirculatingSupply():(uint256)",
      [],
  ...
  getNonCirculatingAddressesCount(): BigInt {
    let result = super.call(
      "getNonCirculatingAddressesCount",
      "getNonCirculatingAddressesCount():(uint256)",
      [],
    );
  ...
  try_getNonCirculatingAddressesCount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getNonCirculatingAddressesCount",
      "getNonCirculatingAddressesCount():(uint256)",
      [],
  ...
  nonCirculatingAddresses(param0: Address): boolean {
    let result = super.call(
      "nonCirculatingAddresses",
      "nonCirculatingAddresses(address):(bool)",
  ...
  try_nonCirculatingAddresses(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "nonCirculatingAddresses",
      "nonCirculatingAddresses(address):(bool)",
      [ethereum.Value.fromAddress(param0)],
  ...
  nonCirculatingAddressesList(param0: BigInt): Address {
    let result = super.call(
      "nonCirculatingAddressesList",
      "nonCirculatingAddressesList(uint256):(address)",
  ...
  try_nonCirculatingAddressesList(
    param0: BigInt,
  ...
  proposalNeedsQueuing(param0: BigInt): boolean {
    let result = super.call(
  ...
  try_proposalNeedsQueuing(param0: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "proposalNeedsQueuing",
      "proposalNeedsQueuing(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
  ...
  proposalVotes(proposalId: BigInt): GovGovernor__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new GovGovernor__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_proposalVotes(
    proposalId: BigInt,
  ): ethereum.CallResult<GovGovernor__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GovGovernor__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
...
export class ConstructorCall__Inputs {
  ...
  get votingDelayBlocks(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get votingPeriodBlocks(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }

  get proposalThresholdTokens(): BigInt {
    return this._call.inputValues[4].value.toBigInt();
  }

  get absoluteQuorumTokens(): BigInt {
    return this._call.inputValues[5].value.toBigInt();
  }

  get initialNonCirculatingAddresses(): Array<Address> {
...
export class AddNonCirculatingAddressCall extends ethereum.Call {
  get inputs(): AddNonCirculatingAddressCall__Inputs {
    return new AddNonCirculatingAddressCall__Inputs(this);
  }

  get outputs(): AddNonCirculatingAddressCall__Outputs {
    return new AddNonCirculatingAddressCall__Outputs(this);
  }
}

export class AddNonCirculatingAddressCall__Inputs {
  _call: AddNonCirculatingAddressCall;

  constructor(call: AddNonCirculatingAddressCall) {
    this._call = call;
  }
...
export class AddNonCirculatingAddressCall__Outputs {
  _call: AddNonCirculatingAddressCall;
...
export class RemoveNonCirculatingAddressCall extends ethereum.Call {
  get inputs(): RemoveNonCirculatingAddressCall__Inputs {
    return new RemoveNonCirculatingAddressCall__Inputs(this);
  }

  get outputs(): RemoveNonCirculatingAddressCall__Outputs {
    return new RemoveNonCirculatingAddressCall__Outputs(this);
  }
}

export class RemoveNonCirculatingAddressCall__Inputs {
  _call: RemoveNonCirculatingAddressCall;

  constructor(call: RemoveNonCirculatingAddressCall) {
    this._call = call;
  }
...
export class RemoveNonCirculatingAddressCall__Outputs {
  _call: RemoveNonCirculatingAddressCall;
...
export class SetAbsoluteQuorumCall extends ethereum.Call {
  get inputs(): SetAbsoluteQuorumCall__Inputs {
    return new SetAbsoluteQuorumCall__Inputs(this);
  }

  get outputs(): SetAbsoluteQuorumCall__Outputs {
    return new SetAbsoluteQuorumCall__Outputs(this);
  }
}

export class SetAbsoluteQuorumCall__Inputs {
  _call: SetAbsoluteQuorumCall;

  constructor(call: SetAbsoluteQuorumCall) {
    this._call = call;
  }
...
export class SetAbsoluteQuorumCall__Outputs {
  _call: SetAbsoluteQuorumCall;
