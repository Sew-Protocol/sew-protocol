...
This staging minimises time-to-IEO, minimises risk of catastrophic loss, and accelerates confidence by observing adversarial behaviour on mainnet *before* introducing resolver-stake economics.
...
> Note: in v1, “punishment” is *workload reduction*, not slashing.
