...
```solidity
event DefaultModuleQueued(bytes32 indexed moduleType, address indexed oldModule, address indexed newModule, uint64 eta);
event DefaultModuleActivated(bytes32 indexed moduleType, address indexed oldModule, address indexed newModule);
```
