...
AccessControl admin hygiene (if using OpenZeppelin AccessControl)

deployer/EOAs do not retain DEFAULT_ADMIN_ROLE after role wiring (revoke/renounce); Timelock holds the effective admin powers post-deploy
